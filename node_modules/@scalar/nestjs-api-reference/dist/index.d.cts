...
type ApiReferenceOptions = Partial<HtmlRenderingConfiguration>;
type NestJSReferenceConfiguration = ApiReferenceOptions & {
    withFastify?: boolean;
};
 ...
 */
declare function apiReference(givenConfiguration: NestJSReferenceConfiguration): ((_req: FastifyRequest, res: ServerResponse) => void) | ((_req: Request, res: Response) => void);

export { type ApiReferenceOptions, type NestJSReferenceConfiguration, apiReference, customThemeCSS };
