...
var import_html_rendering = require("@scalar/core/libs/html-rendering");
var customThemeCSS = `
/* basic theme */
.light-mode {
...
function apiReference(givenConfiguration) {
  ...
  const content = /* @__PURE__ */ __name(() => (0, import_html_rendering.getHtmlDocument)(configuration, customThemeCSS), "content");
